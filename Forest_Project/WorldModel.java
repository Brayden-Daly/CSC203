...
public final class WorldModel {
    ...
    public static void parseDude(WorldModel world, String[] properties, Point pt, String id, ImageStore imageStore) {
        if (properties.length == DudeNotFull.DUDE_NUM_PROPERTIES) {
            Entity entity = new DudeNotFull(id, pt, Double.parseDouble(properties[DudeNotFull.DUDE_ACTION_PERIOD]), Double.parseDouble(properties[DudeNotFull.DUDE_ANIMATION_PERIOD]), Integer.parseInt(properties[DudeNotFull.DUDE_LIMIT]), imageStore.getImageList(DudeNotFull.DUDE_KEY));
            world.tryAddEntity(entity);
        }else{
            throw new IllegalArgumentException(String.format("%s requires %d properties when parsing", DudeNotFull.DUDE_KEY, DudeNotFull.DUDE_NUM_PROPERTIES));
        }
    }
    ...
    public void parseEntity(String line, ImageStore imageStore) {
        ...
        if (properties.length >= ENTITY_NUM_PROPERTIES) {
            ...
            switch (key) {
                ...
                case DudeNotFull.DUDE_KEY -> parseDude(this, properties, pt, id, imageStore);
